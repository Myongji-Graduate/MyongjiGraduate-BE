...
class DataTechnologyMajorTest {
	...
	void 전공필수_기준학점_충족() {
		...
		//given
		User user = UserFixture.데이테크놀로지전공_16학번();
		Set<TakenLecture> takenLectures = new HashSet<>((Set.of(
			TakenLecture.of(user, mockLectureMap.get("HEB01102"), 2016, Semester.FIRST), //기초프로그래밍
			TakenLecture.of(user, mockLectureMap.get("HEB01103"), 2016, Semester.SECOND),
			//객체지향적사고와프로그래밍
			...
			TakenLecture.of(user, mockLectureMap.get("HED01317"), 2021, Semester.FIRST),
			//데이터베이스프로젝트
			...
			TakenLecture.of(user, mockLectureMap.get("HED01405"), 2021, Semester.SECOND),
			//빅데이터기술특론2
	...
	void 전공필수_기준학점_미충족() {
		...
		//given
		User user = UserFixture.데이테크놀로지전공_18학번();
		Set<TakenLecture> takenLectures = new HashSet<>((Set.of(
			TakenLecture.of(user, mockLectureMap.get("HEB01102"), 2018, Semester.FIRST), //기초프로그래밍
			TakenLecture.of(user, mockLectureMap.get("HEB01104"), 2018, Semester.SECOND),
			//객체지향프로그래밍
			...
			TakenLecture.of(user, mockLectureMap.get("HED01317"), 2023, Semester.FIRST),
			//데이터베이스프로젝트
			TakenLecture.of(user, mockLectureMap.get("HED01404"), 2023, Semester.FIRST),
			//빅데이터프로그래밍1
		...
		assertThat(mandatoryDetailCategory.getHaveToLectures()).contains(
