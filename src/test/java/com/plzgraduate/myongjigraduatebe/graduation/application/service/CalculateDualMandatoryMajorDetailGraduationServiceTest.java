...
class CalculateDualMandatoryMajorDetailGraduationServiceTest {
	...
	void isolatePrimaryElectiveMajorDetailGraduation() {
		...
		//when
		DetailGraduationResult primaryMandatoryMajorDetailGraduationResult = calculateDualMandatoryMajorDetailGraduationService.isolateDualMandatoryMajorDetailGraduation(
