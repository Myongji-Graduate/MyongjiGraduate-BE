...
class CalculateDualBasicAcademicalCultureDetailGraduationServiceTest {

	@Mock
	private FindBasicAcademicalCulturePort findBasicAcademicalCulturePort;
	@InjectMocks
	private CalculateDualBasicAcademicalCultureDetailGraduationService calculateDualBasicAcademicalCultureDetailGraduationService;
	...
	void calculateCoreCulture() {
		...
		//when
		DetailGraduationResult detailCoreCultureGraduationResult = calculateDualBasicAcademicalCultureDetailGraduationService.calculateDetailGraduation(
