...
public class PopularLectureController implements PopularLectureApiPresentation {
    ...
    public ResponseEntity<PopularLecturesByCategoryResponse> getPopularLecturesByCategory(
        ...
        return ResponseEntity.ok(
                popularLecturesUseCase.getPopularLectures(major, entryYear, category, limit, cursor)
        );
    }
}
