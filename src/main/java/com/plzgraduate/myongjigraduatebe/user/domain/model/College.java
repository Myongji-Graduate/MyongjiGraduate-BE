...
public enum College {
	...
	BUSINESS("경영대", List.of(
		"경영학전공", "경영정보학과", "국제통상학과", "글로벌비즈니스학전공"),16, 24),
	LAW("법대", List.of("법학과"), 16, 24),
	ICT("ICT융합대", List.of("디지털콘텐츠디자인학과", "응용소프트웨어전공", "데이터테크놀로지전공", "데이터사이언스전공"),16, 24),
	...
	MEDIA_HUMAN_LIFE("미디어·휴먼라이프대", List.of("디지털미디어학부", "청소년지도학전공", "아동학전공"), 25, 99),
