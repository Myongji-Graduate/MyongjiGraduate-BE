...
public enum College {
	...
	HUMANITIES(
		...
		List.of("국어국문학전공", "문예창작학과", "영어영문학전공", "중어중문학전공", "일어일문학전공",
			"문헌정보학전공", "미술사학과", "아랍지역학전공", "사학과", "철학과"), 15, 24),
	SOCIAL_SCIENCE("사회과학대", List.of("행정학전공", "경제학전공", "정치외교학전공", "디지털미디어학부", "아동학전공", "청소년지도학전공"),15, 24),
	BUSINESS("경영대", List.of("경영학전공", "경영정보학과", "국제통상학과"),15, 24),
	LAW("법대", List.of("법학과"), 15, 24),
	ICT("ICT융합대", List.of("디지털콘텐츠디자인학과", "응용소프트웨어전공", "데이터사이언스전공"),15, 24),
