...
class UpdateStudentInformationService implements UpdateStudentInformationUseCase {
	...
	public User updateUser(UpdateStudentInformationCommand updateStudentInformationCommand) {
		...
		user.updateStudentInformation(
			...
			updateStudentInformationCommand.getCompletedSemesterCount(),
			...
			updateStudentInformationCommand.isHonorsCollege(),
			updateStudentInformationCommand.getHonorsTargetMajor()
		);
